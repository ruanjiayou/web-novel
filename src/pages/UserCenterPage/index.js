          ...
          >
            <div className="full-width full-height-fix">
              <div
                ...
                style={{ width: 50, height: 50, margin: '15px 0' }}
              >
                {/* TODO: 测试 */}
              ...
              <VisualBoxView visible={store.app.isLogin}>
                ...
                <div
                  ...
                  onClick={() => router.pushView('UserSetting')}
                >
            ...
            >
              <Card style={{ minHeight: 40, paddingBottom: 0 }}>
                ...
                >
                  ...
                  >
                    <MIconView type="FaLock" style={{ color: '#236f07' }} />
                    安全
                  </div>
                  <div onClick={() => window.location.reload()}>
                    <MIconView type="FaSyncAlt" />
                    刷新
                  </div>
                </div>
              </Card>
              ...
              <Card style={{ minHeight: 40, padding: '10px 0' }}>
                ...
                >
                  ...
                  >
                    <MIconView type="FaListAlt" style={{ color: '#ff5b05' }} />
                    小说
                  </div>
                  <div
                    onClick={() => {
                  ...
                  <div
                    ...
                    style={{ color: '#bb00ff' }}
                  >
                    <MIconView type="IoMdMusicalNote" />
                    歌单
                  </div>
                  <div
                    onClick={() => {
