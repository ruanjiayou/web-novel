        ...
        return (
          <UserAreaView>
            ...
            <FullHeightFix
              ...
              style={{ backgroundColor: '#eee', height: 45, padding: '0 15px' }}
            >
              <MIconView
                type="FaChevronLeft"
                onClick={() => {
            ...
            >
              <VisualBoxView visible={loader.isEmpty}>
                <AutoCenterView>
                  {loader.isError ? (
                    <div>
                      {loader.error.code} {loader.error.message}
                    </div>
                  ) : (
              ...
              >
                <div className="full-width" style={{ height: 40 }}>
                  <span
                    ...
                    style={{
                      opacity:
                        loader.isEmpty || loader.item.preId === '' ? 0.5 : 1,
                    }}
                    onClick={() => {
                  ...
                  <span
                    ...
                    style={{
                      opacity:
                        loader.isEmpty || loader.item.nextId === '' ? 0.5 : 1,
                    }}
                    onClick={() => {
                ...
                <div className="full-width" style={{ height: 50 }}>
                  <div
                    className="full-width-fix dd-common-centerXY"
                    style={{ flexDirection: 'column' }}
                  >
                    <MIconView type="FaListUl" />
                    目录
                  </div>
                  <div
                    className="full-width-auto dd-common-centerXY"
                    style={{ flexDirection: 'column' }}
                  >
                    <MIconView type="FaCog" />
                    设置
                  </div>
                  <div
                    className="full-width-fix dd-common-centerXY"
