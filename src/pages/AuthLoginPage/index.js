            ...
            >
              ...
              <List>
                ...
                <List.Item style={{ display: 'flex' }}>
                  <Button
                    loading={local.isLogin}
                    disabled={local.isLogin || local.isRegister}
                    type="primary"
                    onClick={() => login({ router, local, store, services })}
                  >
                    登录
                  </Button>
                </List.Item>
                  ...
                  <IconSNS
                    ...
                    onClick={() => {
                      window.location.href =
                        'https://api.weibo.com/oauth2/authorize?client_id=177146223&response_type=code&redirect_uri=https://6vq7631482.imdo.co/api/v1/oauth/sns/weibo/callback';
                    }}
                  />
