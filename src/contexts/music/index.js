        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <MIconView
                  style={{ height: 40, lineHeight: '40px', color: '#c557c5' }}
                  type="IoMdMusicalNote"
                />
              </div>
            </Dragger>
          </div>
          ...
          >
            ...
            >
                ...
                <div
                  ...
                  onClick={(e) => {
                    ...
                    if (controls) {
                      let time =
                        state.duration *
                        (ne.layerX / e.currentTarget.offsetWidth);
                      controls.seek(time);
                    }
                  }}
                >
              ...
              <AlignCenterXY>
                <MIconView
                  type={local.mapping[music.mode]}
                  onClick={() => {
                    switch (music.mode) {
                      case music.MODE.ONE:
                        music.setMode(music.MODE.LIST);
                        break;
                      case music.MODE.LIST:
                        music.setMode(music.MODE.CIRCLE);
                        break;
                      case music.MODE.CIRCLE:
                        music.setMode(music.MODE.RANDOM);
                        break;
                      case music.MODE.RANDOM:
                        music.setMode(music.MODE.ONE);
                        break;
                      default:
                        break;
                    }
                ...
                />
                <MIconView
                  type={state.isPlaying ? 'IoIosPause' : 'IoIosPlay'}
                  onClick={() => {
