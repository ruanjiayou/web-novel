...
export default function ({ item }) {
  ...
  return <Observer>
    {() => {
      return <Fragment>
        <div className="full-width" onClick={() => { router.pushView('BookInfo', { id: item.id }) }}>
          ...
          <div className="full-width-auto full-height">
            ...
            <div style={{ padding: '4px 0', color: 'rgb(146, 145, 145)' }}>{item.uname || '佚名'} · {item.types && item.types[0] || '无'}</div>
